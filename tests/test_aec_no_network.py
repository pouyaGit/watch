...
SUITES_UNDER_DENIAL = (
    ...
    "tests.test_aec_evidence_layer",
    "tests.test_aec_orchestrator",
    "tests.test_aec_queue",
    "tests.test_aec_memory",
    "tests.test_aec_surface",
    "tests.test_aec_intelligence",
    "tests.test_aec_assignment",
    "tests.test_aec_memory_connect",
    "tests.test_aec_coordinator",
    "tests.test_aec_review",
    "tests.test_aec_reporting",
    "tests.test_aec_run_replay",
    "tests.test_aec_operating_system",
