...
from dns_brute_common import log, send_telegram, run_puredns, run_httpx_quick, WORKDIR
...
def process_domain(program_name, domain):
    ...
    lines = [f"New subdomains via staticBF -- {program_name} ({domain}): {len(confirmed_live)}"]
