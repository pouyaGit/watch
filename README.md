...
add to ~/.zshrc
alias watch_sync_programs="/opt/watch/programs/watch_sync_programs.py"
alias watch_subfinder="/opt/watch/enum/watch_subfinder.py"
alias watch_findomain="/opt/watch/enum/watch_findomain.py"
alias watch_crtsh="/opt/watch/enum/watch_crtsh.py"
alias watch_abuseipdb="/opt/watch/enum/watch_abuseipdb.py"
alias watch_wayback="/opt/watch/enum/watch_wayback.py"
alias watch_enum_all="/opt/watch/enum/watch_enum_all.py"
alias watch_ns="/opt/watch/ns/watch_ns.py"
alias watch_ns_all="/opt/watch/ns/watch_ns_all.py"
alias watch_http="/opt/watch/http/watch_http.py"
alias watch_http_all="/opt/watch/http/watch_http_all.py"
alias watch_nuclei_all="/opt/watch/nuclei/watch_nuclei_all.py"
...
bash
python3 /opt/watch/crawl/watch_crawl_fresh.py            # fresh http records in pipeline 

python3 /opt/watch/crawl/watch_crawl.py                  # همه
python3 /opt/watch/crawl/watch_crawl.py indeed           # برنامه
python3 /opt/watch/crawl/watch_crawl.py indeed.com       # فقط یک دامنه
